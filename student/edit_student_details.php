                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="history.php"><i class="menu-icon icon-tasks"></i>Sách Đã Trả</a></li>
                                <li><a href="recommendations.php"><i class="menu-icon icon-list"></i>Đề Xuất Sách</a></li>
                                <li><a href="current.php"><i class="menu-icon icon-list"></i>Sách Hiện Đang Mượn</a></li>
                            </ul>
                            <ul class="widget widget-menu unstyled">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $rollno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="Name"><b>Họ Và Tên:</b></label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                            <label class="control-label" for="Category"><b>Thể Loại:</b></label>
                                            <div class="controls">
                                                <select name = "Category" tabindex="1" value="SC" data-placeholder="Select Category" class="span6">
                                                    <option value="<?php echo $category?>"><?php echo $category ?> </option>
                                                    <option value="GEN">Nam</option>
                                                    <option value="OBC">Nữ</option>
                                    ...
                                    <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn-primary"><center>Cập Nhập Thông Tin</center></button>
                                            </div>
                                        </div>                                                                     
