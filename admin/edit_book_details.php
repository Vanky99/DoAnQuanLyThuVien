                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="requests.php"><i class="menu-icon icon-tasks"></i>Yêu Cầu Mượn/Trảs</a></li>
                            ...
                            <div class="module-body">
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Availability">Sô Lượng:</label></b>
                                            <div class="controls">
